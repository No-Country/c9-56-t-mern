const Card = ({ imageSide = "left", image, service, paragraph }) => {
  ...
  return (
    <div className="flex flex-initial max-w-sm justify-center">
      <div
        className={`flex flex-wrap w-full p-[4%] h-full flex-1 bg-gray-50 drop-shadow-md rounded-2xl ${flexDirection} items-center text-center text-neutral-900`}
      >
        ...
        <div className="flex-1 w-auto h-auto px-1 max-w-sm">
          <b><h2 className="text-title max-[320px]:text-base font-title">{service}</h2></b>
