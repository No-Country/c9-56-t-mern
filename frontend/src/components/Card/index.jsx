...
const Card = ({ imageSide = "left", image, service, paragraph }) => {
  ...
  return (
    <div className="flex justify-center">
      <div
        className={`max-w-sm  my-4 h-32 px-2 py-4 bg-gray-50 drop-shadow-md rounded-2xl flex ${flexDirection} justify-around items-center text-center text-neutral-900`}
      >
